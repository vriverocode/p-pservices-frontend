export default {
  ...
  forgot: {
    subtitle: 'Ingresa tu dirección de correo electrónico y te daremos las instrucciones para restablecer la contraseña.',
    back: 'Volver',
    submit: 'Enviar',
    success_title: 'Revisa tu correo electrónico',
    success_message: 'Hemos enviado un enlace para restablecer tu contraseña. Revisa tu bandeja de entrada y sigue las instrucciones.',
    back_to_login: 'Volver al inicio de sesión',
    error_msg: 'No pudimos procesar tu solicitud. Intenta de nuevo más tarde.',
    error_network: 'Error de conexión. Por favor, verifica tu conexión a internet.',
    error_throttle: 'Has realizado demasiadas solicitudes. Intenta de nuevo en un minuto.',
  },
  reset: {
    ...
    submit: 'Restablecer',
    success_msg: 'Contraseña restablecida exitosamente. Ahora puedes iniciar sesión.',
    error_msg: 'No pudimos restablecer tu contraseña. Intenta de nuevo.',
    invalid_token: 'El enlace de restablecimiento no es válido o ha expirado.',
    error_throttle: 'Has realizado demasiadas solicitudes. Intenta de nuevo en un minuto.',
  },
  error404: {
