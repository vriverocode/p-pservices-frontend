export default {
  ...
  forgot: {
    subtitle: "Enter your e-mail address, and we'll give you resert instruction",
    back: 'Back',
    submit: 'Send',
    success_title: 'Check your email',
    success_message: "We've sent a password reset link to your email. Please check your inbox and follow the instructions.",
    back_to_login: 'Back to login',
    error_msg: 'We could not process your request. Please try again later.',
  ...
  reset: {
    ...
    error_msg: 'Could not reset your password. Please try again.',
  ...
  admin: {
    services: {
      ...
      pricing: 'Pricing',
      pricing_title: 'Pricing by category',
      price: 'Price',
  ...
  services_page: {
    ...
    no_vehicles: 'You have no registered vehicles',
    not_found: 'No services found'
  },
  profile: {
